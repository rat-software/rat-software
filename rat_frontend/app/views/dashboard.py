...
def contact():
    ...
    if form.validate_on_submit():
        try:
            # Create an email message using Flask-Mail
            msg = Message(
            ...
            # Uses the central mail instance for sending
            mail.send(msg)
...
def dashboard():
    ...
    # 1. RAT Studies: We retrieve all studies associated with the user, 
    # and sort them in descending order directly in the database (newest first).
    ...
    # 2. Query Sampler Studies: The same for QS Studies.
