...
def export(id):
    ...
    def get_assessments_df():
            """ Creates a DataFrame for ALL assessments (search results, AI overviews, chatbots). """
    ...
    def get_search_results_df():
            """ Creates a DataFrame for the search results including Query/Keyword. """
            sql_query = text("""
                SELECT 
                    q.id AS query_id, 
                    q.query AS keyword, 
    ...
    def get_classifier_results_df():
        """ Creates a DataFrame for the classifier results (raw data). """
    ...
    def get_ai_results_df():
        """ Creates a DataFrame for the AI overview results. """
    ...
    def get_chatbot_results_df():
        """ Creates a DataFrame for the chatbot results. """
    ...
    def get_ai_sources_df():
        """ Creates a DataFrame for the sources of the AI overviews. """
    ...
    def get_top_domains_standard_df():
        """ Retrieves ALL standard domains for export. """
    ...
    def get_top_domains_ai_df():
        """ Retrieves ALL AI-source domains for export. """
        data = get_top_main_domains(study, limit=None)
