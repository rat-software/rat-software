...
def run(query, limit, scraping, headless):
    try:
        ...
        search_url = "https://www.google.com.mx/" #URL of search engine
        ...
        def set_language(driver):
            ...
            driver.get("https://www.google.com.mx/preferences")
            ...
            driver.find_element(By.XPATH, "//div[@id='regionoMX']//span[@class='jfk-radiobutton-radio']").click()
            ...
            driver.find_element(By.LINK_TEXT, "Español (Latinoamérica)").click()
