...
def run(query, limit, scraping, headless):
    ...
    try:
        ...
        search_url = "https://www.google.se/" #URL of search engine
        ...
        def set_language(driver):
            ...
            driver.get("https://www.google.se/preferences")
            ...
            driver.find_element(By.XPATH, "//div[@id='regionoSE']//span[@class='jfk-radiobutton-radio']").click()
