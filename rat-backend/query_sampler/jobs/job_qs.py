...
def job():
    """
    Execute the Query Sampler job.

    This function determines the correct working directory and then runs
    the Query Sampler script using the system's command line interface.
    ...
    qs_job = 'python ' + os.path.join(workingdir, 'generate_keywords.py')
...
if __name__ == '__main__':
    """
    Entry point for the job Query Sampler script.
