...
def run(query, limit, scraping, headless):
    try:
        ...
        search_url = "https://www.google.ie/" #URL of search engine
        ...
        def set_language(driver):
            ...
            driver.get("https://www.google.ie/preferences")
            ...
            driver.find_element(By.XPATH, "//div[@id='regionoIE']//span[@class='jfk-radiobutton-radio']").click()
