...
def run(query, limit, scraping, headless):
    """
    Scrapes video search results from Google Italy based on the provided query.
    ...
    """
    try:
        # Constants for Google Italy search engine scraping
        search_url = "https://www.google.it/search?hl=it&gl=IT&tbm=vid&prmd=ivnbz&source=lnt&uule=w+CAIQICIFSXRhbHk="
        captcha_marker = "g-recaptcha"  # Marker to identify CAPTCHA on the page
        next_page_xpath = "//a[@aria-label='{}']"  # XPath template for locating the "Next" button
        ...
        driver = Driver(
            ...
            locale_code="it",  # Set locale to Italian
            no_sandbox=True
        )
