...
def run(query, limit, scraping, headless):
    try:
        ...
        search_url = "https://www.dogpile.com/" #URL of search engine, e. g. www.google.de
        ...
        next_page = "//a[@class='pagination__num pagination__num--next-prev pagination__num--next']" #CSS to find click on next SERP; for search engines that use a navigation on SERPS to continue browsing more search results
        ...
        def get_search_results(driver, page):
            ...
            for result in soup.find_all("div", class_=["web-bing__result"]):
                ...
                try:
                    for title in result.find("a", class_=["web-bing__title"]):
                ...
                try:
                    ...
                    for description in result.find_all("span", class_=["web-bing__description"]):
                ...
                #limit number of results but add x amount on top
                if counter < limit+2:
