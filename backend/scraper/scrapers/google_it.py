...
def run(query, limit, scraping, headless):
    ...
    search_url = "https://www.google.it/webhp?hl=it&gl=IT&uule=w+CAIQICIFSXRhbHk="  # URL for Google search
    ...
    get_search_url = "https://www.google.it/search?q="  # Base URL for search results
