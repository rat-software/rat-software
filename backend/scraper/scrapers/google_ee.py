...
def run(query, limit, scraping, headless):
    try:
        ...
        search_url = "https://www.google.ee/" #URL of search engine
        ...
        def set_language(driver):
            ...
            driver.get("https://www.google.ee/preferences")
            ...
            driver.find_element(By.XPATH, "//div[@id='regionoEE']//span[@class='jfk-radiobutton-radio']").click()
            ...
            driver.find_element(By.LINK_TEXT, "eesti").click()
