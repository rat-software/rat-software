...
def run(query, limit, scraping, headless):
    ...
    search_url = "https://www.google.de/webhp?hl=de&gl=DE&uule=w+CAIQICIHR2VybWFueQ=="  # URL for Google search
    ...
    get_search_url = "https://www.google.de/search?q="  # Base URL for search results
