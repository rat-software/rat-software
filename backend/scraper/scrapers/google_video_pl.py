...
def run(query, limit, scraping, headless):
    """
    Scrapes video search results from Google Poland based on the provided query.

    Args:
        query (str): The search query to be used in Google video search.
        limit (int): The maximum number of search results to retrieve.
        scraping (Scraping): An instance of the Scraping class used for additional operations such as encoding and taking screenshots.
    ...
    try:
        ...
        search_url = "https://www.google.pl/search?hl=pl&gl=PL&tbm=vid&prmd=ivnbz&source=lnt&uule=w+CAIQICIGUG9sYW5k="
        ...
        time.sleep(random.randint(2, 5))  # Random delay to reduce detection risk
