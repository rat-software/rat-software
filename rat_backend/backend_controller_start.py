...
if __name__ == "__main__":
    ...
    process2 = threading.Thread(target=classifier, name="ClassifierControllerThread")
    process2.start()

    process3 = threading.Thread(target=query_sampler, name="QuerySamplerControllerThread")
    process3.start()
